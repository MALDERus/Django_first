...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authapp', '0003_auto_20211005_2326'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2021, 10, 7, 20, 41, 37, 394013, tzinfo=utc), verbose_name='актуальность ключа'),
        ),
