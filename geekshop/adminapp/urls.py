...
urlpatterns = [
    ...
    # path('users/read/', adminapp.users, name='users'), >>> Заменяем на CBV >>>
    path('users/read/', adminapp.UsersListView.as_view(), name='users'),
    path('users/update/<int:pk>/', adminapp.user_update, name='user_update'),
    path('users/delete/<int:pk>/', adminapp.user_delete, name='user_delete'),

    # path('categories/create/', adminapp.category_create, name='category_create'), >>> Заменяем на CBV >>>
    ...
    # path('categories/update/<int:pk>/', adminapp.category_update, name='category_update'), >>> Заменяем на CBV >>>
    path('categories/update/<int:pk>/', adminapp.ProductCategoryUpdateView.as_view(), name='category_update'),
    # path('categories/delete/<int:pk>/', adminapp.category_delete, name='category_delete'), >>> Заменяем на CBV >>>
    ...
    # path('products/read/<int:pk>/', adminapp.product_read, name='product_read'), >>> Заменяем на CBV >>>
